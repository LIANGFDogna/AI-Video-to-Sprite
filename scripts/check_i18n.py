...
EXTRA = ['Animation content exceeds project canvas.', '3  Edit', '4  Sprite', '5  Export', 'Main Animation', 'Overlay', 'Effects', 'Reference', 'Add XY to Selection', 'Apply Duration / Curve', 'Apply Frame Count', 'Apply Speed', 'Apply Transform to Selection', 'Bezier: drag the two control points', 'Build Sprite Sheet', 'Destination Track', 'Drag: move frame · Arrows: 1px · Shift: 10px · Middle drag: pan', 'Edit Animation', 'Edit Keyed Frames', 'Edits are non-destructive. Reference track and preview overlays are excluded from exports.', 'Frame Scale', 'Ghost Opacity', 'Insert Selected Sources', 'Interpolate Selected Transforms', 'Keep First Frame', 'Keep Last Frame', 'Keep Marked Keyframes', 'Lock', 'Mark / Unmark Keyframes', 'Neighbor Frames', 'Offset X (cell px)', 'Offset Y (cell px)', 'Opacity', 'Paste at End', 'Prepare Editor', 'Prepare the current frames to start editing.', 'Preparing animation editor', 'Preview FPS', 'Process all keyed frames before editing.', 'Redo', 'Undo', 'Rendering timeline frames', 'Ripple / Insert', 'Root Trajectories', 'Selected: {count} frames', 'Set the first Root for alignment, or use Edit Keyed Frames on the Key page.', 'Show', 'Source Frame {frame}', 'Source frame {frame} · {duration:.4f}s', 'Source {source} → Output {output} frames', 'Speed Multiplier', 'Stop', 'Target Duration (s)', 'Target Frame Count', 'Timeline', 'Timeline has no visible frames', 'Timeline output exceeds 100000 frames', 'Timing Curve', 'Track', 'Tracks / Resources', 'Root / Character Space', 'Motion / Ground', 'Alignment Options', 'Select All', 'Copy', 'Paste at Playhead', 'Delete Frames', 'Reverse', 'Linear', 'Ease In', 'Ease Out', 'Ease In Out', 'Custom Bezier', 'X / Y Axes', 'Ground Line', 'Safe Area', '+', '−'] + [
