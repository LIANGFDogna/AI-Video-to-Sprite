STYLE = """
QWidget { background: #161d28; color: #dbe4f2; font-size: 12px; }
...
QLabel#muted { color: #91a1b8; line-height: 1.4; }
...
QLineEdit, QSpinBox, QDoubleSpinBox, QComboBox { background: #111925; border: 1px solid #35435a; border-radius: 4px; padding: 5px; min-height: 18px; }
QComboBox QAbstractItemView { background: #202c3d; selection-background-color: #365875; }
QTabBar::tab { background: #1b2636; color: #91a1b8; padding: 12px 18px; border-bottom: 2px solid #1b2636; }
...
QTableView { background: #151e2b; alternate-background-color: #1b2738; border: 1px solid #2d3a4f; selection-background-color: #304b65; }
...
QSplitter::handle { background: #101722; width: 5px; height: 5px; }
...
QPlainTextEdit { background: #101722; color: #bccadd; border: 1px solid #34445c; font-family: Consolas; }
"""
